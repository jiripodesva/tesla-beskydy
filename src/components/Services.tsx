...
const SERVICES = [
  {
    ...
    copy: "Zapomeňte na klasické hotely. Camp Mode udržuje ideální teplotu celou noc. Spěte na matraci s lůžkovinami a výhledem na hvězdy skrze panoramatické sklo.",
  },
  {
    icon: Zap,
